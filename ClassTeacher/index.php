...
// Requête SQL pour récupérer le nom de la classe et le bras de classe
        ...
        <div class="container-fluid" id="container-wrapper">
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">
              Class Teacher Dashboard (<?php echo htmlspecialchars($className . ' - ' . $classArmName); ?>)
            </h1>
            <ol class="breadcrumb">
